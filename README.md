...
sudo apt install build-essential cmake libdrogon-dev libpqxx-dev \
...
Drogon HTTP + REST API
    ...
    ├── MQTTClient          (Eclipse Paho, auto-reconnect)
...
- **Devices** -- Add/edit/delete devices, pairing with PIN
